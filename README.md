...
キャラクターの口の開き具合は、`client/main.js`の`applyMouthOpenValue`関数内で調整できます。v1.3では2.5倍に増幅されています。
...
最新のアップデート（v1.3）では、リップシンク機能に以下の改善を加えました：
...
これらの改善により、キャラクターの口の動きがより人間らしく、テキスト音声に自然に同期するようになりました。
